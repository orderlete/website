         ...
         <div className="px-5 -mt-12 relative z-10 bg-white rounded-t-[48px] pt-10 space-y-8">
            <div className="space-y-4">
               ...
               <div className="flex items-center gap-4 py-1">
                  <div className="flex items-center gap-2 px-3 py-2 bg-orange-50/50 rounded-xl border border-orange-100/50">
                     ...
                     <span className="text-[10px] text-gray-400 font-bold">({reviewCount > 0 ? `${reviewCount} verified` : 'Mock data'})</span>
                  </div>
            ...
            <div className="flex items-center justify-between py-8 border-y border-gray-100/50">
               <div className="flex flex-col">
                  ...
                  <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-2">Plus delivery fee</span>
               </div>
            ...
            <section className="space-y-4">
               <div className="flex items-center gap-2 text-gray-400">
                  ...
                  <h3 className="text-[10px] font-black uppercase tracking-[0.2em]">Product Story</h3>
               </div>
               <div className="bg-gray-50/30 p-8 rounded-[40px] border border-gray-100/50">
                  <p className="text-[15px] text-gray-600 font-bold leading-relaxed">
                    {product.about || product.description || "Crafted with passion using hand-picked ingredients for a truly premium experience."}
                  </p>
               </div>
            </section>
