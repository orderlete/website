        ...
        <div className="relative aspect-[1/1] w-full overflow-hidden rounded-[24px] bg-gray-50">
          ...
          {product.stock > 0 ? (
            ...
            <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px] flex items-center justify-center p-4">
               <div className="bg-red-500 text-white px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.2em] shadow-2xl">Sold Out</div>
            </div>
          )}
        </div>
      </Link>

      <div className={cn("p-3 space-y-3 transition-opacity", product.stock === 0 && "opacity-50 pointer-events-none")}>
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          <div className="flex items-center bg-gray-50 rounded-2xl p-0.5 border border-gray-100/50">
            {product.stock > 0 ? (
               ...
               <div className="px-3 py-2 text-[9px] font-black text-gray-300 uppercase tracking-widest bg-gray-100 rounded-xl">
                  Unavailable
               </div>
            )}
          </div>
